...
extern unsigned char rom_PokemonYellow_nes[];
extern unsigned int rom_PokemonYellow_nes_len;
...
struct rom roms[] = {
  ...
  { .name = "PokemonYellow", .body = rom_PokemonYellow_nes, .size = &rom_PokemonYellow_nes_len, },
